...
// একটি Social App-এর API একটি Nested User Object Return করে। Destructuring ব্যবহার করে
//  Nested Data থেকে Name, Age এবং Hobby List-এর First Item বের করতে হবে।
// Input
...
const extractUserInfo = (userObj)=>{
    ...
    // const {user:{name,age:userAge},hobbies}= userObj;
    // const [firstHobby = `nothing yet`] = hobbies;
    const {user:{name,age:userAge},hobbies:[firstHobby= `nothing yet`]}=userObj;

// একটি কোডিং একাডেমি নতুন শিক্ষার্থীদের var, let, const এর পার্থক্য বোঝাতে একটি ছোট Quiz Tool বানাচ্ছে। Tool-টি একটি keyword ইনপুট নেবে এবং 
// সেই keyword দিয়ে Redeclare ও Reassign করা যায় কিনা তা বর্ণনা করবে।
// Input
...
const describeDeclaration = (keyword) =>{
    if(keyword === "var"){
        return `Can redclare, can reassign`
    }
    else if(keyword === "let"){
        return `Cannot redclare, can reassign`
    }
    else if(keyword === "const"){
        return `Cannot redclare. cannot reassign`
    }
    else{
        return "Invalid"
    }
...
console.log(describeDeclaration("funct"));